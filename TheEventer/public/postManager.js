const postManager = (function () {
    ...
    let photoPosts = [
        ...
        post('2', 'Дерись как девчонка', 'Семинар по женской самообороне от Krav Maga Belarus.',
            '2018-02-21T22:00:00', 'Иванов Василий', 'assets/fight.jpg', 'global', '2018-03-10T12:00:00', '16', ['#самооборона', '#женская_самооборона'], []),
        ...
        post('13','Помощь интернату', 'Для небольших строительных работ ищем двух волонтеров',
            '2018-03-06T11:20:00', 'Иванов Владимир','assets/volont.jpg', 'local', '2018-03-10T12:00:00', '18', ['#музыка','#благотворительность', '#волонтер'], []),
    ...
    const filters = {
        ...
        plannedFor: (postPlannedFor, filterPlannedFor) => {
            if (Array.isArray(filterPlannedFor)){
                ...
                return  (postPlannedFor.getFullYear() === filterPlannedFor.getFullYear()) &&
                    (postPlannedFor.getMonth() === filterPlannedFor.getMonth())
                    && (postPlannedFor.getDate() === filterPlannedFor.getDate());
        },
